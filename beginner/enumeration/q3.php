    ...
    <div class="container" id="myContainer">
        <div id="left">
            <div id="title">
                ...
                <p id="content">What is this <img src="../../img/shape3.png" alt="square" class="shape"> and <img src="../../img/shape2.png" alt="pentagon" class="shape"> called?</p>
            </div>
            <img src="../../img/pink.gif" alt="pink pokemon" id="img">
        </div>

        <div id="right">
            <input type="text" id="ans1" style="margin-top: 300px;" placeholder="Answer here">
...
<script>
    ...
    function sub(){
        ...
        //list
        var shape = ['square', 'pentagon'];
        
        //check if correct
        for(var i = 0; i < shape.length; i++){
            if(input1.value == shape[i] || input2.value == shape[i]){ //get score if all correct
                var final = parseInt(exist)+1; //add
            }else if(input1.value != shape[i] || input2.value != shape[i]){ //0 score if one of it not correct
                var final = parseInt(exist)+0; //add
            }else{
                var final = parseInt(exist)+0; //add
            }

    ...
    <div class="container" id="myContainer">
        <div id="left">
            <div id="title">
                ...
                <p id="content">What do bees make?</p>
            </div>
...
<script>
    ...
    function sub(){
        ...
        //list
        var bee = ['honey', 'hive', 'venom'];
        
        //check if correct
        for(var i = 0; i < bee.length; i++){
            if(input1.value == bee[i] || input2.value == bee[i] || input3.value == bee[i]){ //get score if all correct
                var final = parseInt(exist)+1; //add
            }else if(input1.value != bee[i] || input2.value != bee[i] || input3.value != bee[i]){ //0 score if one of it not correct
                var final = parseInt(exist)+0; //add
            }else{
                var final = parseInt(exist)+0; //add
            }

    ...
    <div class="container" id="myContainer">
        <div id="left">
            <div id="title">
                ...
                <p id="content">What a baby cat called?</p>
            </div>
            <img src="../../img/pink.gif" alt="pink pokemon" id="img">
        </div>

        <div id="right">
            <input type="text" id="ans1" style="margin-top: 400px;" placeholder="Answer here">
...
<script>
    ...
    function sub(){
        ...
        if(input1.value.toLowerCase() == "kitten"){
            var final = parseInt(exist)+1;
        }else{
            var final = parseInt(exist)+0;
        }
        localStorage.setItem("score", final); //save the value input
        var seconds = parseInt(secs) + parseInt(sec);
        var minutes = parseInt(mins) + parseInt(min);
